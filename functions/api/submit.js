...
<body style="margin:0;padding:0;background:#111111;font-family:Arial,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:48px 24px;">
    ...
    <p style="color:#8C8C8C;font-size:14px;line-height:1.7;margin:0 0 28px;">We'll follow up shortly with a full breakdown - what's pulling each score down and exactly what it would take to hit 100% across the board.</p>
